...
const GET_USER_LIST='http://boss.icarbonx.com/bosssport/user/students/info/{currentPage}'
const GET_COACH_LIST='http://boss.icarbonx.com/bosssport/user/coaches/info/{currentPage}'
...
const VALIDATION_COACH_INFO='http://boss.icarbonx.com/bosssport/user/coach/validation/{coachId}/info'
